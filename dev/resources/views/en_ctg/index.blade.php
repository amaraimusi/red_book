...
<head>
	...
	<title>絶滅危惧種カテゴリー管理画面</title>
	
	<script src="{{ asset('/js/app.js') }}" defer></script>
	<script src="{{ $crud_base_js . $ver_str }}" defer></script>
	<script src="{{ asset('/js/EnCtg/index.js')  . $ver_str }}" defer></script>
...
@include('layouts.common_header')
	...
	<!-- 検索条件入力フォーム -->
	<form action="" class="form_kjs" id="en_ctgIndexForm" method="post" accept-charset="utf-8">
		
		<?php $this->CrudBase->inputKjMain('kj_main','',null,'絶滅危惧種カテゴリー名、備考を検索する');?>
		...
		$this->CrudBase->inputKjText('kj_en_ctg_name','絶滅危惧種カテゴリー名');
	...
	<div id="main_tools" style="margin-bottom:10px;margin-top:4px">
		<div style="display:inline-block;width:75%; ">
			<?php 
				...
				// CSVエクスポート機能
	 			$csv_dl_url =  'en_ctg/csv_download';
...
<!-- 一覧テーブル -->
<table id="en_ctg_tbl" class="table table-striped table-bordered table-condensed" style="display:none;margin-bottom:0px">
...
<table id="crud_base_forms">
	...
	<tr id="ajax_crud_new_inp_form" class="crud_base_form" style="display:none;padding-bottom:60px"><td colspan='5'>
		...
		<div class="cbf_inp_wrap">
			<div class='cbf_inp' >絶滅危惧種カテゴリー名: </div>
			<div class='cbf_input'>

...
<head>
	...
	<title>綱クラス管理画面</title>
	
	<script src="{{ asset('/js/app.js') }}" defer></script>
	<script src="{{ $crud_base_js . $ver_str }}" defer></script>
	<script src="{{ asset('/js/BioCls/index.js')  . $ver_str }}" defer></script>
...
@include('layouts.common_header')
	...
	<!-- 検索条件入力フォーム -->
	<form action="" class="form_kjs" id="bio_clsIndexForm" method="post" accept-charset="utf-8">
		
		<?php $this->CrudBase->inputKjMain('kj_main','',null,'綱クラス名、備考を検索する');?>
		...
		$this->CrudBase->inputKjText('kj_bio_cls_name','綱名');
	...
	<div id="main_tools" style="margin-bottom:10px;margin-top:4px">
		<div style="display:inline-block;width:75%; ">
			<?php 
				...
				// CSVエクスポート機能
	 			$csv_dl_url =  'bio_cls/csv_download';
...
<!-- 一覧テーブル -->
<table id="bio_cls_tbl" class="table table-striped table-bordered table-condensed" style="display:none;margin-bottom:0px">

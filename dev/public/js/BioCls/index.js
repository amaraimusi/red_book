...
jQuery(()=> {
	...
	$('#bio_cls_tbl').show();// 高速表示のためテーブルは最後に表示する
...
//			{'field':'bio_cls_group', 'inp_type':'select', 'list':bio_clsGroupList, 'def':2}, 
//			{'field':'bio_cls_date', 'inp_type':'date', 'def':today}, 
//			{'field':'note', 'inp_type':'text', 'def':'TEST'}, 
//			{'field':'sort_no', 'inp_type':'sort_no', 'def':1}, 
		],
		{
			ajax_url:'bio_cls/bulk_reg',
			csrf_token:csrf_token,
			ta_placeholder:"Excelからコピーした綱クラス名、綱クラス数値を貼り付けてください。（タブ区切りテキスト）\n(例)\n綱クラス名A\t100\n綱クラス名B\t101\n",
		}
	);
...
function calendarViewKShow(){
	// カレンダービューを生成 
	crudBase.calendarViewCreate('bio_cls_date');
}

...
jQuery(()=> {
	...
	$('#en_ctg_tbl').show();// 高速表示のためテーブルは最後に表示する
...
//			{'field':'en_ctg_group', 'inp_type':'select', 'list':en_ctgGroupList, 'def':2}, 
//			{'field':'en_ctg_date', 'inp_type':'date', 'def':today}, 
//			{'field':'note', 'inp_type':'text', 'def':'TEST'}, 
//			{'field':'sort_no', 'inp_type':'sort_no', 'def':1}, 
		],
		{
			ajax_url:'en_ctg/bulk_reg',
			csrf_token:csrf_token,
			ta_placeholder:"Excelからコピーした絶滅危惧種カテゴリー名、絶滅危惧種カテゴリー数値を貼り付けてください。（タブ区切りテキスト）\n(例)\n絶滅危惧種カテゴリー名A\t100\n絶滅危惧種カテゴリー名B\t101\n",
		}
	);
...
function calendarViewKShow(){
	// カレンダービューを生成 
	crudBase.calendarViewCreate('en_ctg_date');
}
